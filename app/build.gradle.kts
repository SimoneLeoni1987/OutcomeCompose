...
if (keystorePropertiesFile.exists() && keystorePropertiesFile.isFile) {
    ...
    println("Warning: keystore.properties file not found. Release builds may not be signed.")
}

android {
    namespace = "it.simo.outcomecompose"
    compileSdk = 35

    defaultConfig {
        applicationId = "it.simo.outcomecompose"
        minSdk = 30
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
